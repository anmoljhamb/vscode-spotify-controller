...
export async function activate(context: vscode.ExtensionContext) {
    ...
    registerCommand({
        commandId: "playTrackWithoutConfirmation",
        func: playTrackTemplate({
    ...
    registerCommand({
        commandId: "playTrackWithoutContext",
        func: playTrackTemplate({
    ...
    registerCommand({
        commandId: "playTrackWithoutContextWithoutConfirmation",
        func: playTrackTemplate({
            title: "Play Track Without Context",
    ...
    registerCommand({
        commandId: "addToQueueWithoutConfirmation",
        func: playTrackTemplate({
            title: "Add Track To Queue",
    ...
    registerCommand({
        ...
        func: async () => {
            ...
            if (!choice) return;
            const artists = (await spotifyApi.searchArtists(choice)).body
                .artists;
    ...
    registerCommand({
        commandId: "removeFromLikedSongs",
        func: async () => {
            const resp = await spotifyApi.getMyCurrentPlayingTrack();
            if (!resp.body.item) {
                throw new Error("Currently not playing anything");
    ...
    async function registerCommand({
        ...
        if (protectedCommand === undefined) protectedCommand = true;
